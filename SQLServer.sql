...
AS
		...
		--SEGUNDO BLOCO -  Atribuição de valores
		SET @DATA = GETDATE()
...
--Diferente da trigger que vc é um bloco nomeado - vc da um nome a trigger
--Muito usado em teste, pois voce nao quer ter isso salvo no seu banco
